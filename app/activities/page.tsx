...
import { NodesPanel } from '../../components/features/NodesPanel';
import { InboundActionsPanel } from '../../components/features/InboundActionsPanel';
import { OutboundActionsPanel } from '../../components/features/OutboundActionsPanel';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-lg shadow-xl w-[min(1100px,96vw)] max-h-[95vh] p-4 space-y-3 flex flex-col">
            ...
            <div className="flex-1 overflow-auto">
              <NodesPanel fixedFromActivityId={nodesActivity.id} modalZIndex={60} />
            </div>
          </div>
        </div>
      )}
      ...
      {inboundActivity && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-lg shadow-xl w-[min(1000px,96vw)] max-h-[95vh] p-4 space-y-3 flex flex-col">
            ...
            <div className="flex-1 overflow-auto">
              <InboundActionsPanel fixedActivityId={inboundActivity.id} modalZIndex={60} />
            </div>
          </div>
        </div>
      )}
      ...
      {outboundActivity && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-lg shadow-xl w-[min(1000px,96vw)] max-h-[95vh] p-4 space-y-3 flex flex-col">
            ...
            <div className="flex-1 overflow-auto">
              <OutboundActionsPanel fixedActivityId={outboundActivity.id} modalZIndex={60} />
            </div>
          </div>
        </div>
      )}
